...
export function ToastNotification({ id, type, message, duration = 5000, onClose }: ToastNotificationProps) {
  ...
  return (
    <div
      className={`flex items-center gap-3 p-4 border rounded-lg shadow-lg transition-all duration-300 min-w-[300px] max-w-md ${
        colors[type]
